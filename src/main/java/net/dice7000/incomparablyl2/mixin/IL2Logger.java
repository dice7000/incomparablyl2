...
public class IL2Logger implements Logger {
    private final String name;
    private final BufferedWriter writer;

    public IL2Logger(String name) {
        this.name = name;
        try {
            this.writer = new BufferedWriter(
                    new OutputStreamWriter(
                            new FileOutputStream("mylog.txt", true),
    ...
    @Override public void info(String format, Object arg) { info(format.formatted(arg)); }
    ...
    @Override public void error(String format, Object arg) { error(format.formatted(arg)); }
